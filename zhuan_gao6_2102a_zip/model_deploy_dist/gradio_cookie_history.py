...
from util_mysql import enqueue as enqueue_mysql, get_sorted_by_key as get_sorted_by_key_mysql
...
def get_history(username):
    ...
    rows_out = get_sorted_by_key_mysql(mydb, 'dialog_out', username, limit=3, is_keep_others=False)
